...
%USERPROFILE%\desktop\qemu\qemu-system-x86_64.exe -m %RAM% -smp %SMP% -drive format=raw,file=%USERPROFILE%\desktop\%NAME% -drive format=raw,media=cdrom,readonly,file=%USERPROFILE%\desktop\%ISONAME%




:no
%USERPROFILE%\desktop\qemu\qemu-system-x86_64.exe -m %RAM% -smp %SMP% -drive format=raw,file=%USERPROFILE%\desktop\%NAME%
